...
このドキュメントは、**Kitu** フレームワークの全体像（アーキテクチャ・開発フロー・デプロイモデル）を説明します。  
Kitu は **Rust バックエンド + Unity クライアント** という構成で、決定的（deterministic）なゲームロジックと、高速な開発サイクル、開発者体験の向上を目的としています。
...
## 4. 通信レイヤー（OSC + osc‑ir + MessagePack）
