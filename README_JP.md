...
![はじめに](doc/assets/introduction.png)
...
![アーキテクチャ概要](doc/assets/high-level-architecture.png)
...
![バックエンドゲームロジック](doc/assets/backend-game-logic-rust.png)
...
![通信レイヤー](doc/assets/communication-layer-osc-osc-ir-messagepack.png)
...
![Unity クライアント](doc/assets/unity-client-presentation-layer.png)
...
![データシステム](doc/assets/data-systems-tmd-sqlite.png)
...
![タイムラインとオートメーション](doc/assets/timeline-and-automation-tsq1.png)
